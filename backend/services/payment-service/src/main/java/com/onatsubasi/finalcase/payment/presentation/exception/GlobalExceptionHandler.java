package com.onatsubasi.finalcase.payment.presentation.exception;
...
public class GlobalExceptionHandler {
        ...
        public ResponseEntity<ErrorResponse> handleBaseException(
                ...
                log.warn(
                                "event=payment.business_exception errorCode={} message={} correlationId={}",
        ...
        public ResponseEntity<ErrorResponse> handleValidationException(
                ...
                log.warn(
                                "event=payment.validation_failed errorCount={} correlationId={}",
                                errors.size(),
                                correlationId);
        ...
        public ResponseEntity<ErrorResponse> handleConstraintViolation(
                ...
                log.warn(
                                "event=payment.constraint_violation errorCount={} correlationId={}",
                                errors.size(),
                                correlationId);
        ...
        public ResponseEntity<ErrorResponse> handleHttpMessageNotReadable(
                ...
                log.debug(
                                "event=payment.malformed_request correlationId={}",
                                correlationId,
                                ex);
        ...
        public ResponseEntity<ErrorResponse> handleTypeMismatch(
                ...
                log.warn(
                                "event=payment.type_mismatch parameter={} value={} correlationId={}",
                                ex.getName(),
                                ex.getValue(),
                                correlationId);
        ...
        public ResponseEntity<ErrorResponse> handleDataIntegrityViolation(
                ...
                log.warn(
                                "event=payment.data_integrity_violation correlationId={}",
                                correlationId,
                                ex);
        ...
        public ResponseEntity<ErrorResponse> handleUnexpectedException(
                ...
                log.error(
                                "event=payment.unexpected_error correlationId={}",
                                correlationId,
                                ex);
