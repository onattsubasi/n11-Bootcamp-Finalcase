package com.onatsubasi.finalcase.catalog.presentation.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBaseException(
        ...
        try {
            ...
            log.warn(
                    "Catalog business exception occurred, errorCode={}, message={}",
    ...
    public ResponseEntity<ErrorResponse> handleMethodArgumentNotValid(
        ...
        try {
            ...
            log.warn("Catalog validation failed, fieldErrorCount={}", errors.size());
    ...
    public ResponseEntity<ErrorResponse> handleConstraintViolation(
        ...
        try {
            ...
            log.warn("Catalog constraint validation failed, fieldErrorCount={}", errors.size());
    ...
    public ResponseEntity<ErrorResponse> handleUnreadableMessage(
        ...
        try {
            ...
            log.warn("Catalog malformed request body: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleTypeMismatch(
        ...
        try {
            ...
            log.warn(
                    "Catalog request parameter type mismatch, parameter={}, requiredType={}",
                    ex.getName(),
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrityViolation(
        ...
        try {
            MDC.put("errorCode", CatalogErrorCode.DUPLICATE_CATALOG_RECORD.code());

            String correlationId = request.getHeader(PlatformHeaders.X_CORRELATION_ID);

            log.warn("Catalog data integrity violation occurred: {}", ex.getMostSpecificCause().getMessage());

            return ResponseEntity
                    .status(CatalogErrorCode.DUPLICATE_CATALOG_RECORD.httpStatus())
                    .body(ErrorResponse.of(
                            CatalogErrorCode.DUPLICATE_CATALOG_RECORD,
                            CatalogErrorCode.DUPLICATE_CATALOG_RECORD.defaultMessage(),
                            correlationId
                    ));
        } finally {
            MDC.remove("errorCode");
    ...
    public ResponseEntity<ErrorResponse> handleAuthenticationException(
        ...
        try {
            ...
            log.warn("Catalog authentication exception occurred: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleAccessDeniedException(
        ...
        try {
            ...
            log.warn("Catalog access denied exception occurred: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleUnexpectedException(
        ...
        try {
            ...
            log.error("Unexpected catalog-service error occurred", ex);
