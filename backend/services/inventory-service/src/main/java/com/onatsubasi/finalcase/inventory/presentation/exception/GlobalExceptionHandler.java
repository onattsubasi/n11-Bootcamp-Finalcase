package com.onatsubasi.finalcase.inventory.presentation.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBaseException(
        ...
        try {
            ...
            log.warn(
                    "Inventory business exception occurred, errorCode={}, message={}",
    ...
    public ResponseEntity<ErrorResponse> handleMethodArgumentNotValid(
        ...
        try {
            ...
            log.warn("Inventory request validation failed, fieldErrorCount={}", errors.size());
    ...
    public ResponseEntity<ErrorResponse> handleConstraintViolation(
        ...
        try {
            ...
            log.warn("Inventory constraint validation failed, fieldErrorCount={}", errors.size());
    ...
    public ResponseEntity<ErrorResponse> handleUnreadableMessage(
        ...
        try {
            ...
            log.warn("Inventory malformed request body: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleTypeMismatch(
        ...
        try {
            ...
            log.warn(
                    "Inventory request parameter type mismatch, parameter={}, requiredType={}",
                    ex.getName(),
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrityViolation(
        ...
        try {
            ...
            log.warn(
                    "Inventory data integrity violation occurred: {}",
    ...
    public ResponseEntity<ErrorResponse> handleAuthenticationException(
        ...
        try {
            ...
            log.warn("Inventory authentication exception occurred: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleAccessDeniedException(
        ...
        try {
            ...
            log.warn("Inventory access denied exception occurred: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleMethodNotAllowed(
        ...
        try {
            ...
            log.warn("Inventory method not allowed: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleUnsupportedMediaType(
        ...
        try {
            ...
            log.warn("Inventory unsupported media type: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleUnexpectedException(
        ...
        try {
            ...
            log.error("Unexpected inventory-service error occurred", ex);
