package com.onatsubasi.finalcase.search.presentation.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBaseException(
        ...
        try {
            ...
            log.warn(
                    "Search business exception occurred, errorCode={}, message={}",
    ...
    public ResponseEntity<ErrorResponse> handleMethodArgumentNotValid(
        ...
        try {
            ...
            log.warn("Search request validation failed, fieldErrorCount={}", errors.size());
    ...
    public ResponseEntity<ErrorResponse> handleConstraintViolation(
        ...
        try {
            ...
            log.warn("Search constraint validation failed, fieldErrorCount={}", errors.size());
    ...
    public ResponseEntity<ErrorResponse> handleUnreadableMessage(
        ...
        try {
            ...
            log.warn("Search malformed request body: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleTypeMismatch(
        ...
        try {
            ...
            log.warn(
                    "Search request parameter type mismatch, parameter={}, requiredType={}",
                    ex.getName(),
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrityViolation(
        ...
        try {
            ...
            log.warn(
                    "Search data integrity violation occurred: {}",
    ...
    public ResponseEntity<ErrorResponse> handleAuthenticationException(
        ...
        try {
            ...
            log.warn("Search authentication exception occurred: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleAccessDeniedException(
        ...
        try {
            ...
            log.warn("Search access denied exception occurred: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleMethodNotAllowed(
        ...
        try {
            ...
            log.warn("Search method not allowed: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleUnsupportedMediaType(
        ...
        try {
            ...
            log.warn("Search unsupported media type: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleUnexpectedException(
        ...
        try {
            ...
            log.error("Unexpected search-service error occurred", ex);
