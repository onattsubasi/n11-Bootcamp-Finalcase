package com.onatsubasi.finalcase.review.presentation.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBaseException(
        ...
        try {
            ...
            log.warn(
                    "Review business exception occurred, errorCode={}, message={}",
    ...
    public ResponseEntity<ErrorResponse> handleMethodArgumentNotValid(
        ...
        try {
            ...
            log.warn("Review request validation failed, fieldErrorCount={}", errors.size());
    ...
    public ResponseEntity<ErrorResponse> handleConstraintViolation(
        ...
        try {
            ...
            log.warn("Review constraint validation failed, fieldErrorCount={}", errors.size());
    ...
    public ResponseEntity<ErrorResponse> handleUnreadableMessage(
        ...
        try {
            ...
            log.warn("Review malformed request body: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleTypeMismatch(
        ...
        try {
            ...
            log.warn(
                    "Review request parameter type mismatch, parameter={}, requiredType={}",
                    ex.getName(),
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrityViolation(
        ...
        try {
            ...
            log.warn(
                    "Review data integrity violation occurred: {}",
    ...
    public ResponseEntity<ErrorResponse> handleAuthenticationException(
        ...
        try {
            ...
            log.warn("Review authentication exception occurred: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleAccessDeniedException(
        ...
        try {
            ...
            log.warn("Review access denied exception occurred: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleMethodNotAllowed(
        ...
        try {
            ...
            log.warn("Review method not allowed: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleUnsupportedMediaType(
        ...
        try {
            ...
            log.warn("Review unsupported media type: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleUnexpectedException(
        ...
        try {
            ...
            log.error("Unexpected review-service error occurred", ex);
