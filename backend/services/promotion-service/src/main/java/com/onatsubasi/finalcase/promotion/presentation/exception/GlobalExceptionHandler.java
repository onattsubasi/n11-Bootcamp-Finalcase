package com.onatsubasi.finalcase.promotion.presentation.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBaseException(
        ...
        try {
            ...
            log.warn(
                    "Promotion business exception occurred, errorCode={}, message={}",
    ...
    public ResponseEntity<ErrorResponse> handleMethodArgumentNotValid(
        ...
        try {
            ...
            log.warn("Promotion request validation failed, fieldErrorCount={}", errors.size());
    ...
    public ResponseEntity<ErrorResponse> handleConstraintViolation(
        ...
        try {
            ...
            log.warn("Promotion constraint validation failed, fieldErrorCount={}", errors.size());
    ...
    public ResponseEntity<ErrorResponse> handleUnreadableMessage(
        ...
        try {
            ...
            log.warn("Promotion malformed request body: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleTypeMismatch(
        ...
        try {
            ...
            log.warn(
                    "Promotion request parameter type mismatch, parameter={}, requiredType={}",
                    ex.getName(),
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrityViolation(
        ...
        try {
            ...
            log.warn(
                    "Promotion data integrity violation occurred: {}",
    ...
    public ResponseEntity<ErrorResponse> handleAuthenticationException(
        ...
        try {
            ...
            log.warn("Promotion authentication exception occurred: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleAccessDeniedException(
        ...
        try {
            ...
            log.warn("Promotion access denied exception occurred: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleMethodNotAllowed(
        ...
        try {
            ...
            log.warn("Promotion method not allowed: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleUnsupportedMediaType(
        ...
        try {
            ...
            log.warn("Promotion unsupported media type: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleUnexpectedException(
        ...
        try {
            ...
            log.error("Unexpected promotion-service error occurred", ex);
