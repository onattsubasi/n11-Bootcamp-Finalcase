    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/customer/checkout/**")
                        .hasAnyRole("CUSTOMER", "ADMIN")

                        .requestMatchers("/api/admin/checkouts/**")
                        .hasRole("ADMIN")

                        /*
                         * API Gateway must not expose /internal/** publicly.
                         * These endpoints are service-to-service / ops endpoints.
                         */
                        .requestMatchers("/internal/checkouts/**")
                        .permitAll()
